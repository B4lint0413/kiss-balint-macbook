<template>
  <BaseLayout>
    <div v-if="loaded">
      <RouterLink class="block m-2 rounded bg-amber-500 text-white p-2 w-[100px] text-center" :to="{name: 'edit-laptop', params: {id: laptop.id}}">Módosítás</RouterLink>
      <BaseTable :laptop="laptop"></BaseTable>
    </div>
...
export default{
  ...
  methods: {
    ...mapActions(useLaptop, ['getLaptop'])
  },
  async mounted(){
